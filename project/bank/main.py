...
"""
users={
        1001:{'name':"bhavani",'gmail':"bhavani@gmail.com",'balance':5000,'password':'1001'},
        1002:{'name':"lakshmi",'gmail':"lakshmi@gmail.com",'balance':1000,'password':'1002'}
        }
...
def register(username:str,gmail:str,balance:int,password:str)-> int:
    return "register page under developement"
